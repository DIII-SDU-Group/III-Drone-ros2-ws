...
`10.41.10.2`. Host firewall policy accepts only PX4-originated runtime MAVLink on
`14540/UDP`, receiver-audit MAVLink on `14541/UDP`, and uXRCE-DDS on `8888/UDP`. The runtime API listens for MAVLink on
